...
/*
  ...
  Modified from AFLGo by Alessandro Palazzolo for integration with Mist.

  Original AFLGo source:
...
#define SP20    SP10 SP10
  ...
  // custom mist START
  #if AFLGO_IMPL
  sprintf(tmp, "%0.01f/%0.01f/%0.01f", cur_distance, min_distance, max_distance);

  SAYF(bSTOP "       distance : " cRST "%-21s " bSTG bV "\n", tmp);
  #else
  // custom mist END
